      ...
      <div className="fixed bg-[#0034DC] flex h-[80px] lg:h-[64px] items-center justify-between left-0 top-0 w-full z-50 px-6 shadow-sm lg:shadow-none" data-name="Nav">
        ...
        <div className="flex items-center gap-3 lg:gap-8">
          <div className="hidden lg:flex items-center gap-8">
            <a href="/" className="text-white font-['VoloSansPro:Bold',sans-serif] text-[14px] tracking-wide hover:text-[#c7ff10] transition-colors">Leagues</a>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-[#0034DC] flex flex-col lg:hidden animate-in slide-in-from-right duration-300">
          ...
          <div className="flex-1 flex flex-col p-6 gap-6 pt-10">
            <a href="/" className="text-[#c7ff10] font-['VoloSansPro:Bold',sans-serif] text-[32px] font-bold tracking-tight active:scale-[0.98] transition-all flex items-center gap-3">
              Leagues
            </a>
...
function Container4() {
  return (
    <div className="flex flex-wrap gap-2 items-center relative shrink-0 w-full" data-name="Container">
      <div className="bg-[#f4f4f5] flex items-center gap-1.5 h-[32px] px-3.5 relative rounded-full shrink-0" data-name="badge">
        <Trophy />
        <span className="font-['VoloSansPro'] font-bold text-[#18181b] text-[14px] leading-none">Leagues</span>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['VoloSansPro'] font-bold justify-center leading-[1.1] not-italic relative shrink-0 text-[46px] text-white w-full max-w-[1124px] tracking-tight">
        <p>Volleyball · Indoor · Recreational · 6v6 · Coed</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Location">
      ...
      <div className="flex flex-col font-['VoloSansPro'] font-bold justify-center leading-tight not-italic relative shrink-0 text-[14px] text-white">
        <p>Immaculate Conception Academy</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['VoloSansPro'] font-bold justify-center leading-tight not-italic relative shrink-0 text-[14px] text-white">
        <p>Mondays • Starts Jan 26, 2026</p>
      </div>
    </div>
  );
}
...
function Header() {
  return (
    <div className="bg-[#0f172a] content-stretch flex flex-col gap-[10px] h-auto min-h-[400px] lg:min-h-[480px] items-start overflow-clip relative rounded-none lg:rounded-[24px] shadow-none lg:shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-full z-0" data-name="Header">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-0 max-w-none top-0 w-full object-cover" src="https://s3.amazonaws.com/rivall-user-uploads/prodUploads/leagueHeader/53f518db-4b8c-4531-9bad-9956f4cb82fe/b658fe4d-a037-46e1-b1ee-4a29974d3ad8_icon.avif" />
      </div>
...
function Container11({ isOn, activeTab, setTab, phase, setPhase }: { isOn: boolean; activeTab: string; setTab: (t: string) => void; phase: string; setPhase: (p: string) => void }) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([e]) => {
        // Since it's sticky at top-[60px], it's "stuck" when its top position is exactly 60px.
        // We use a small buffer to detect this.
  ...
  return (
    <div className="content-stretch flex flex-col gap-[24px] lg:gap-[56px] items-start relative flex-1 min-w-0 w-full" data-name="Container">
      <div
        ref={stickyRef}
        className={`lg:hidden sticky top-[60px] z-40 w-[calc(100%+3rem)] -mx-6 px-6 py-4 transition-all duration-300 ${isSticky ? 'bg-white border-b border-[#f1f5f9] shadow-sm pt-8' : 'bg-transparent border-transparent'}`}
      >
  ...
  return (
    <div className="hidden lg:flex flex-col shrink-0 w-full lg:w-[373.33px] relative" data-name="Container">
      <div className="sticky top-[100px] flex flex-col gap-[16px] items-start self-start pb-[100px] w-full">
        <EarlyBirdSoloPresenter isOn={isOn} setIsOn={setIsOn} activeTab={activeTab} setTab={setTab} phase={phase} setPhase={setPhase} />
        <Container62 />
      </div>
    </div>
  );
...
export default function LeagueV() {
  ...
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col items-center pt-[0px] lg:pt-[100px] pb-[100px] relative size-full min-h-screen" data-name="League - V1">
      ...
      <Footer />
      <MobileFooter isOn={includeFees} setIsOn={setIncludeFees} activeTab={tab} setTab={setTab} phase={phase} />
    </div>
  );
}